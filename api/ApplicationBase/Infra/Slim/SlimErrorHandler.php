...
class SlimErrorHandler extends ErrorHandler
{
	...
	private function notifyDiscord(Throwable $t):void{
		...
		$embeds = [new Embed(title: "New Exception Detected. Code: " . $t->getCode() . ". Exception class: " . $t::class, type: "rich", description: "Endpoint: " . $_SERVER['REQUEST_URI']. " - Trace Below", color: 15158332)];
